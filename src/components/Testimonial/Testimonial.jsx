        ...
        <div className="mx-auto  px-4 py-16 sm:px-6 sm:py-24 lg:me-0 lg:pe-0 lg:ps-8">
          <div className="grid grid-cols-1 gap-y-8 lg:grid-cols-3 lg:items-center lg:gap-x-16 ml-0 md:ml-12">
            <div className="max-w-xl text-center ltr:sm:text-left rtl:sm:text-right">
              ...
              <div className="hidden lg:mt-8 lg:flex lg:gap-4 ml-96">
                ...
                <button className="next-button rounded-full border border-red-500 p-3 text-red-500 hover:bg-red-500 hover:text-white">
              ...
              <div className="swiper-container !overflow-hidden">
                <div className="swiper-wrapper">
                  <div className="swiper-slide">
                    <blockquote className="flex h-full flex-col justify-between bg-gray-100 p-12">
                      <div>
                      ...
                      <footer className="mt-8 text-sm text-red-500">
                        &mdash; User
                      </footer>
                    </blockquote>
                  </div>
          ...
          <div className="mt-8 flex justify-center gap-4 lg:hidden">
            <button
              ...
              className="prev-button rounded-full border border-red-500 p-4 text-red-500 hover:bg-red-500 hover:text-white"
            >
              <svg
            ...
            <button
              ...
              className="next-button rounded-full border border-red-500 p-4 text-red-500 hover:bg-red-500 hover:text-white"
            >
              <svg
                className="h-5 w-5"
                fill="none"
